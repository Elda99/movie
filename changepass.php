	...
	<div class="wrap">
		<div class="content-left" style="min-height:300px;padding:20px;width:100%">
			<div class="col-md-12">
				<div class="panel panel-default">
				  <div class="panel-heading">Ndrysho Paswordin</div>
				...
				?>
				<p class="login-box-msg">Ndryshoni paswordin <?php echo $row['r_nm']; ?></p>
     ...
     <input type="hidden" name="id" value="<?php echo $row['r_id']; ?>">
      ...
      <div class="form-group">
          <button type="submit" class="btn btn-primary">Ndrysho Password</button>
