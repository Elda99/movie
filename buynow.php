...
<center><h3 style="color:blue;text-transform:uppercase;font-weight:bold">Movie Name :<?php echo $movie['m_nm']; ?></font></b></h3>	</center>
	<div class="about-top">
		...
		<div class="desc span_3_of_2">
			<p class="p-link" style="font-size:15px"><b>Aktoret: </b><?php echo $movie['m_cnm']; ?></p>
			<p class="p-link" style="font-size:15px"><b>Data e realizimit :</b> <?php echo date('d-M-Y',strtotime($movie['m_date'])); ?></p>
			<p style="font-size:15px"><b>Pershkrimi :</b> <?php
{
	echo $movie['m_des'];
}
?></p>
